...
pub fn hadamard_float() {
    ...
    let result = GpuTensor::new(vec![2, 2], vec![f64::exp(5.0), f64::exp(12.0), f64::exp(21.0), f64::exp(32.0)]).unwrap();
...
pub fn exp_float() {
    ...
    let result = GpuTensor::new(vec![2, 2], vec![f64::exp(1.0), 12.0, 21.0, 32.0]).unwrap();
