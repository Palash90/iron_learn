mod matrix_ops {
    ...
    pub fn mul_random() {
        ...
        let m2 = Matrix::new(
            vec![6, 6],
            vec![
                738, 55, 22, 872, 611, 303, 365, 543, 283, 374, 951, 798, 150, 866, 398, 272, 583,
                470, 92, 342, 83, 307, 882, 731, 769, 944, 548, 567, 601, 258, 143, 572, 527, 58,
                446, 734,
            ],
        )
        .unwrap();
        let result = Matrix::new(
            vec![6, 6],
            vec![
                1004890, 1149009, 673288, 1116056, 1615821, 1303342, 1426717, 1339880, 812467,
                1501216, 1934959, 1475992, 1344343, 1643620, 864697, 1363112, 1803598, 1183384,
                1199968, 1364922, 785273, 1430627, 2112552, 1748690, 1070927, 2085626, 1211457,
                1130720, 2154502, 1863808, 1473774, 1600363, 854472, 1580452, 1898626, 1273112,
            ],
        )
        .unwrap();
