...
mod tests {
    ...
    fn test_div_large_data() {
        ...
        println!("Count of first tensor 1s: {}", t1.get_data().iter().filter(|x| **x == 1.0).count());
        println!("Count of second tensor 2s: {}", t2.get_data().iter().filter(|x| **x == 2.0).count());
        println!("Count of result with 0.5: {}", data.iter().filter(|x| **x == 0.5).count());
    ...
    fn test_hadamard_large_data() {
        ...
        println!("Count of first tensor 1s: {}", t1.get_data().iter().filter(|x| **x == 1.0).count());
        println!("Count of second tensor 2s: {}", t2.get_data().iter().filter(|x| **x == 2.0).count());
        println!("Count of result with 2.0: {}", data.iter().filter(|x| **x == 2.0).count());
    ...
    fn test_add_large_data() {
        ...
        println!("Count of first tensor 1s: {}", t1.get_data().iter().filter(|x| **x == 1.0).count());
        println!("Count of second tensor 2s: {}", t2.get_data().iter().filter(|x| **x == 2.0).count());
        println!("Count of result with 3.0: {}", data.iter().filter(|x| **x == 3.0).count());
    ...
    fn test_sub_large_data() {
        ...
        println!("Count of first tensor 1s: {}", t1.get_data().iter().filter(|x| **x == 1.0).count());
        println!("Count of second tensor 2s: {}", t2.get_data().iter().filter(|x| **x == 2.0).count());
        println!("Count of result with -1.0: {}", data.iter().filter(|x| **x == -1.0).count());
